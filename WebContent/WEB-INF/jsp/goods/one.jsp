	...
	<div class="banner-top">
		<div class="container">
			...
			<h3 class="animated wow fadeInRight" data-wow-delay=".5s">
				<a href="index/homeShow">主页</a><label>/</label>商品详情
			</h3>
			<div class="clearfix"></div>
		</div>
	</div>
					...
					<div class="product-head">
						<div class="product-go">
							<div class=" fashion-grid">
								<a href="goods/get?g_id=14"><img class="img-responsive "
									src="${basePath}upload/20812f8a-2548-4445-9399-7a76bb1fda92.jpg" alt=""></a>

							</div>
							<div class=" fashion-grid1">
								<h6 class="best2">
									<a href="goods/get?g_id=14">红色玫瑰花香皂花 </a>
								</h6>
								<span class=" price-in1">￥158
								</span>
								<p>红色玫瑰花香皂花</p>
							</div>
						...
						<div class="product-go">
							<div class=" fashion-grid">
								<a href="goods/get?g_id=15"><img class="img-responsive "
									src="${basePath}upload/c6e29ece-4044-4e38-8e2b-c4ef66bc7e16.jpg" alt=""></a>

							</div>
							<div class=" fashion-grid1">
								<h6 class="best2">
									<a href="goods/get?g_id=15">玫瑰花香皂花</a>
								</h6>
								<span class=" price-in1">￥4
								</span>
								<p>玫瑰花香皂花</p>
							</div>
							<div class="clearfix"></div>
			...
			<div class="col-md-9 animated wow fadeInRight" data-wow-delay=".5s">
						...
						<ul class="slides">
							<li data-thumb="${basePath}upload/${g.photo1}">
								<div class="thumb-image">
									<img src="${basePath}upload/${g.photo1}" data-imagezoom="true"
										class="img-responsive">
								</div>
							</li>
							<li data-thumb="${basePath}upload/${g.photo2}">
								<div class="thumb-image">
									<img src="${basePath}upload/${g.photo2}" data-imagezoom="true"
										class="img-responsive">
								</div>
							</li>
							<c:if test="${g.photo3 != ''}">
								<li data-thumb="${basePath}upload/${g.photo3}">
									<div class="thumb-image">
										<img src="${basePath}upload/${g.photo3}" data-imagezoom="true"
											class="img-responsive">
									</div>
								</li>
							</c:if>
				...
				<div class="col-md-7 single-top-in">
					<div class="span_2_of_a1 simpleCart_shelfItem">
						<h3>${g.title}</h3>
						<p class="in-para">
							<img src="images/tick1.png">七天无理由退货 &nbsp; <img
								src="images/tick1.png">72小时内发货 &nbsp; <img
								src="images/tick1.png">急速退款 &nbsp; <img
								src="images/tick1.png">蚂蚁花呗
						</p>
						<div class="price_single">
							...
							<c:choose>
								...
								<c:otherwise>
									<a href="javascript:void(0);" onclick="atc('${g.g_id}');"
